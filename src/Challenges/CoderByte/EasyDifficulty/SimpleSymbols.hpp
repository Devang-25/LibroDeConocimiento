#ifndef SRC_CHALLENGES_CODERBYTE_EASYDIFFICULTY_SIMPLESYMBOLS_HPP
#define SRC_CHALLENGES_CODERBYTE_EASYDIFFICULTY_SIMPLESYMBOLS_HPP
...
#endif // SRC_CHALLENGES_CODERBYTE_EASYDIFFICULTY_SIMPLESYMBOLS_HPP
